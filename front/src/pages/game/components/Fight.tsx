                            ...
                            <div className="ui grid">
                                <div className="two wide column">
                                    <div className="ui one  column centered grid">
                                        ...
                                        <div className="row">
                                            <div
                                                className=" column">{joinedRoom?.firstPlayerId == userId ? 'Me' : joinedRoom?.firstPlayerName}</div>
                                        </div>
                                                ...
                                                <div
                                                    ...
                                                    {joinedRoom?.energyUserFirst &&
                                                        <Progress progress='value'
                                                                  value={joinedRoom?.energyUserFirst * 100 / 200 + ""}
                                                                  color='teal'/>
                                                    }
                            ...
                            <div className="ui grid">
                                <div className="two wide column">
                                    <div className="ui one  column centered grid">
                                            ...
                                            <div className="column">
                                                <div id="progressBarId2">
                                                    ...
                                                    {joinedRoom?.energyUserSecond &&
                                                        <Progress progress='value'
                                                                  value={joinedRoom?.energyUserSecond * 100 / 200 + ""}
                                                                  color='teal'/>
                                                    }
                                        ...
                                        <div className="row">
                                            <div
                                                className=" column">{joinedRoom?.secondPlayerId == userId ? 'Me' : joinedRoom?.secondPlayerName}</div>
                                        </div>
                                        <div className="row">
                                            <div className="column"><i className="user circle huge icon "></i></div>
                                        </div>
